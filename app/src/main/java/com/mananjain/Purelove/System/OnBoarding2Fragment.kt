...
class OnBoarding2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val nextbtn : Button = view.findViewById(R.id.next_btn2)
        val prevbtn : Button = view.findViewById(R.id.prev_btn2)
    ...
    private fun prevfragment() {
        fragmentManager!!.beginTransaction().replace(R.id.fl_onboarding, OnBoarding1Fragment()).commit()
